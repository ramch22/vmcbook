...
<section markdown="1">
<h2 class="section-header" id="network-extension">Network Extension</h2>
...
<section markdown="1">
<h2 class="section-header" id="workload-migration">Workload Migration</h2>
...
<section markdown="1">
<h2 class="section-header" id="network-cutover">Network Cutover</h2>
